...
val GallerySectionStyle by ComponentStyle {
    ...
    cssRule(" > #columnParent > #galleryTitle") {
        Modifier
    ...
    cssRule(":hover > #columnParent > #galleryTitle") {
        Modifier
            .color(Theme.Primary.rgb)
            .translateX(5.percent)
    }

    cssRule(" > #columnParent > #galleryDesc") {
        Modifier
            .translateX(0.percent)
            .transition(CSSTransition(property = "translate", duration = 200.ms))
    }

    cssRule(":hover > #columnParent > #galleryDesc") {
        Modifier
            .translateX(5.percent)
    }
}

val GalleryArrowIconStyle by ComponentStyle {
    base {
        Modifier
